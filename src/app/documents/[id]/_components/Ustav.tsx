...
const Ustav = () => {
  ...
  const participant1Details = getDetails(participant1Status, 1);
  const participant2Details = getDetails(participant2Status, 2);
    ...
    () => [
      [
        ...
        ...participant2Details,
        {
          ...
          type: "text",
          label: "Введите полное наименование Товарищества на казахском языке",
        },
        {
          variant: "input",
          ...
          type: "text",
          label:
            "Введите короткое наименование Товарищества на казахском языке",
        },
        {
          variant: "input",
          name: "company_name_ru_full",
          type: "text",
          label: "Введите полное наименование Товарищества на русском языке",
        },
        {
          variant: "input",
          name: "company_name_ru_short",
          type: "text",
          label: "Введите короткое наименование Товарищества на русском языке",
        },
        {
          variant: "input",
          name: "company_name_en_full",
          type: "text",
          label: "Введите полное наименование Товарищества на английском языке",
        },
        {
          variant: "input",
          ...
          type: "text",
          label:
            "Введите короткое наименование Товарищества на английском языке",
        },
        {
          variant: "input",
          name: "company_location",
          type: "text",
          label: "Укажите местонахождение ТОО",
        },
        {
          variant: "input",
          name: "company_duration",
          type: "text",
          label: "Укажите, на какой срок создается ТОО",
        },
      ],
      [
        { variant: "title", name: "Уставной капитал и доли участия" },
        {
          ...
          type: "number",
          label: "Укажите уставной капитал ТОО (в тенге)",
        },
        {
          variant: "input",
      ...
      [
        { variant: "title", name: "Органы управления и контроля" },
        {
          ...
          name: "control_body",
          type: "radio",
          label: "Какой орган является контролирующим в Товариществе?",
          radioVariant: [
            { value: "ревизионная комиссия", label: "Ревизионная комиссия" },
            { value: "ревизор", label: "Ревизор" },
            { value: "иной орган", label: "Иной орган" },
          ],
        },
        {
          variant: "radio",
